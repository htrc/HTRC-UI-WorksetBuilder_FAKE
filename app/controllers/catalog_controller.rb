...
class CatalogController < ApplicationController  
  ...
  configure_blacklight do |config|
    ...
    config.add_facet_field 'publishDate', :label => 'Publication Year', :single => true
    config.add_facet_field 'topicStr', :label => 'Topic', :limit => 20
    config.add_facet_field 'language', :label => 'Language', :limit => true
    config.add_facet_field 'authorStr', :label => 'Author', :limit => true
    ...
    config.add_show_field 'title_a', :label => 'Title:'
    ...
    config.add_search_field 'allfields', :label => 'All Fields'
